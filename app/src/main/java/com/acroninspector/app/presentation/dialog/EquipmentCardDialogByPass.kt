...
import com.acroninspector.app.databinding.DialogEquipmentCardBypassBinding
...
class EquipmentCardDialogByPass(
        private val equipmentInteractor: EquipmentInteractor
) : DialogFragment() {

    private lateinit var binding: DialogEquipmentCardBypassBinding

    private lateinit var equipmentDisposable: Disposable

    private lateinit var onClickDefectList: () -> Unit

    private lateinit var onClickRegisterDefect: () -> Unit

    private var equipmentId: Int = DEFAULT_INVALID_ID

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_equipment_card_bypass, container, false)
    ...
    fun show(manager: FragmentManager, tag: String?, onClickDefectList: () -> Unit,
             onClickRegisterDefect: () -> Unit, equipmentId: Int) {
        this.onClickDefectList = onClickDefectList
        this.onClickRegisterDefect = onClickRegisterDefect
    ...
    companion object {
        const val TAG = "Acron.Tag.EquipmentByPassDialog"
    }
}