...
class InProgressTasksFragment : TasksFragment(), InProgressTasksView {
    ...
    @Inject
    @InjectPresenter
    lateinit var presenter: InProgressTasksPresenter

    @ProvidePresenter
    fun providePresenter(): InProgressTasksPresenter = presenter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getSwipeRefreshLayout().isEnabled = false
    }
